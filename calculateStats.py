...
df1 = df[['Tm', 'FDPt', 'Rec']]
df1['FDPts_per_Rec'] = (df1['FDPt'] / df1['Rec'])
#df1['Rec_Rank'] = df1['Rec'].rank(ascending=False)
#df1['FDpR'] = df1['FDPts_per_Rec'].rank(ascending=False)

print(df1)
df1.to_csv('calcTest.csv', index=False)